...
export const HireMe = () => {
  return (
    <div data-aos="flip-up" id="hireMe" className="site__hireme py-7 md:py-14">
      <div className="flex mx-4 md:mx-0 flex-col px-4 md:px-20 md:flex-row">
        <div
          style={{ background: "#00A78E" }}
          className="container rounded-xl mx-auto p-4 md:p-20"
        >
          <div className="flex flex-col md:flex-row">
            <div className="site__hireme-text w-full md:w-1/2 flex flex-col md:justify-center">
              ...
              <div
                className="site__line mx-auto md:mx-0 border-solid my-2 md:my-4 w-52"
                style={{ background: "#fff", height: "2px" }}
              ></div>
              <p className="font-normal text-base w-full leading-7 text-center md:text-left text-white">
                {LANGUAGES.home.hireMeSubTitle}
              </p>
            </div>

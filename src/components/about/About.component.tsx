        ...
        <div className="site__about">
            <div className="flex flex-col px-2 md:px-0 pt-7 md:pt-14">
                ...
                <div className="container mx-auto justify-between flex flex-col md:flex-row">
                    <div className="site__about-picture pt-6 md:pt-0 w-full md:w-1/2 flex">
                        <img src={profile} alt="" className="site__about-img bg-contain h-auto rounded-lg w-5/6 mx-auto md:mx-0" />
                    </div>
                    <div className="site__about-text w-full md:w-1/2 flex flex-col md:justify-center">
                        <h2 className="text-3xl md:text-4xl font-bold pt-4 md:pt-6" style={{ fontFamily: "cursive", color: "#293651" }}>{LANGUAGES.home.whyHireMe}</h2>
                        <div className="site__line border-solid my-2 md:my-4 w-2/3" style={{ background: '#00A78E', height: '2px' }}></div>

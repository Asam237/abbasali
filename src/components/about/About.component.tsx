  ...
  return (
    <div id="about" className="site__about">
      <div className="flex flex-col px-4 md:px-20 pt-10 md:pt-28">
        ...
        <div className="container mx-auto justify-between flex flex-col-reverse md:flex-row">
          <div
            data-aos="fade-right"
            className="site__about-picture pt-3 md:pt-0 w-full md:w-1/2 flex"
          >
            <img
              src={profile}
              alt=""
              className="site__about-img bg-contain h-auto rounded-lg w-5/6 mx-auto md:mx-0"
            />
          </div>
          <div
            data-aos="fade-left"
            className="site__about-text w-full md:w-1/2 flex flex-col md:justify-center"
          >
            <h2
            ...
            <div
              className="site__line mx-auto md:mx-0 border-solid my-2 md:my-4 w-1/3 md:w-2/3"
              style={{ background: "#00A78E", height: "2px" }}
            ></div>
            <p
              className="font-normal text-base w-full md:w-4/5 leading-7 my-5"
              style={styles}
            >
              {LANGUAGES.home.aboutBody}
            </p>

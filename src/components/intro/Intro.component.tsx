        ...
        <div className="site__intro">
            <div className="flex flex-col md:flex-row px-4 md:px-20 pt-10 md:pt-24">
                ...
                <div className="container mx-auto justify-between flex flex-col md:flex-row">
                    <div data-aos="fade-right" className="site__intro-description w-full md:w-1/2">
                    ...
                    <div data-aos="fade-left" className="site__intro-picture pt-6 md:pt-0 w-full md:w-1/2 flex justify-center">
